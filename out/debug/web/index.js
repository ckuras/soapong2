...
var ASM_CONSTS = {
  1098904: () => { if (document.fullscreenElement) return 1; },  
 1098950: () => { return document.getElementById('canvas').width; },  
 1099002: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099070: () => { document.exitFullscreen(); },  
 1099097: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099170: () => { if (document.fullscreenElement) return 1; },  
 1099216: () => { return document.getElementById('canvas').width; },  
 1099268: () => { return screen.width; },  
 1099293: () => { document.exitFullscreen(); },  
 1099320: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1099453: () => { if (document.fullscreenElement) return 1; },  
 1099499: () => { return document.getElementById('canvas').width; },  
 1099551: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099619: () => { if (document.fullscreenElement) return 1; },  
 1099665: () => { return document.getElementById('canvas').width; },  
 1099717: () => { return screen.width; },  
 1099742: () => { if (document.fullscreenElement) return 1; },  
 1099788: () => { return document.getElementById('canvas').width; },  
 1099840: () => { return screen.width; },  
 1099865: () => { document.exitFullscreen(); },  
 1099892: () => { if (document.fullscreenElement) return 1; },  
 1099938: () => { return document.getElementById('canvas').width; },  
 1099990: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100058: () => { document.exitFullscreen(); },  
 1100085: () => { return screen.width; },  
 1100110: () => { return screen.height; },  
 1100136: () => { return window.screenX; },  
 1100163: () => { return window.screenY; },  
 1100190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1100243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1100314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1100371: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1100442: () => { if (document.fullscreenElement) return 1; },  
 1100488: () => { if (document.pointerLockElement) return 1; }
};
...
var _game_init = Module['_game_init'] = createExportWrapper('game_init', 0);
var _game_update = Module['_game_update'] = createExportWrapper('game_update', 0);
